    ...
    <div>
      ...
      <div class="skills">
        <div class="tech-skills">
          ...
          <h3>Python, C, Java, JavaScript</h3>
          <h2>Data Science:</h2>
          ...
          <p>
            ...
            <br />- Backend: Python <br />- Frameworks: Flask - Databases: MySQL
          </p>
        </div>
